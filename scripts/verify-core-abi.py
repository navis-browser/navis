...
ABI_ENTRYPOINTS = (
    ...
    "navis_core_runtime_configure_extension_contribution",
    "navis_core_runtime_create_session",
    "navis_core_runtime_create_session_with_mode",
    "navis_core_runtime_detach",
    "navis_core_runtime_extension_contribution_snapshot",
    ...
    "navis_core_runtime_set_extension_contribution_context_enabled",
    "navis_core_runtime_set_extension_contribution_enabled",
